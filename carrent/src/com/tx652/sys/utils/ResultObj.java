...
public class ResultObj {
	 ...
	 * 状态码=0
	 */
	public static final ResultObj STASTUS_TRUE = new ResultObj(SysConstast.CODE_SUCCESS);
	/**
	 * 
	 * 状态码=-1
	 */
	public static final ResultObj STASTUS_ERROR = new ResultObj(SysConstast.CODE_ERROR);
	
	
	
	
	
	//外界不能创建或者初始化ResultObj对象
